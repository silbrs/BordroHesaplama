    ...
    <tbody>
        ...
        if(!empty($cikti)){
            ...
            <tr class="text-center">
                ...
                <td><?php echo !empty($value['ad'])?$value['ad']:''; ?></td>
                <td><?php echo !empty($value['soyad'])?$value['soyad']:''; ?></td>
                ...
                <td><a href="yillikMaas.php?id=<?php echo $value['ID'];?>" class="btn btn-danger">Yıllık Maaş</a></td>
            </tr>
        <?php } } ?>
    </tbody>
    </table>
